  ...
  useEffect(() => {
    const fetchRequests = async () => {
      try {
        ...
        setRequests(data);
        // Автовыбор первой заявки, если ещё ничего не выбрано
        if (!selectedRequest && Array.isArray(data) && data.length > 0) {
    ...
    <section className="admin">
      ...
      <div className="container">
        <div className="admin-controls card">
          ...
          <a href="/" className="btn" style={{marginLeft:'auto'}}>
            На главную
          </a>
        ...
        <div className="requests-container">
          <div className="requests-split">
            <Reveal className="list-pane card" y={18}>
                      ...
                      >
                        ...
                        {request.comment && (
                          <div className="request-comment">
                            ...
                            <p>{request.comment.length > 100 ? `${request.comment.substring(0, 100)}...` : request.comment}</p>
                          </div>
                        )}
                      </div>
                    ))}
            ...
            <Reveal className="details-pane request-details" y={18}>
              {!selectedRequest ? (
                <div className="empty-details">
                  <h3>Выберите заявку слева</h3>
                  <p>Здесь отобразятся детали выбранной заявки.</p>
                </div>
              ) : (
                <>
                    ...
                    <div className="detail-group">
                      ...
                      <div className="status-controls">
                        ...
                        <select
                          ...
                          className={`status-update-select ${statusColors[selectedRequest.status]}`}
                        >
