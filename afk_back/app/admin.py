...
class ContentBlockAdmin(admin.ModelAdmin):
    list_display = ("page_key", "block_key", "content_type", "updated_by", "updated_at")
    list_filter = ("content_type",)
    search_fields = ("page_key", "block_key", "content")

@admin.register(GalleryImage)
class GalleryImageAdmin(admin.ModelAdmin):
    list_display = ("page_key", "id", "caption", "order", "uploaded_by", "created_at")
