"""
Django settings for afk_back project.
...
SECRET_KEY = 'django-insecure-hx^8k=@k_c13_juv6rme^@3!dz8r9hc54o@700#mrt4*xy0t7y'
...
WSGI_APPLICATION = 'afk_back.wsgi.application'
